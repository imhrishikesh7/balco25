    ...
    return (
        <div>
            <div className='marginal'>
                <div className='pb-20'>
                    <h1 className='text-2xl sm:text-4xl lg:text-5xl font-light pb-6 sm:pb-8'>
                        Materiality matters
                    </h1>
                    ...
                    <div className='w-full flex flex-col lg:flex-row gap-6'>
                        ...
                        <div className='flex-1'>
                            <h2 className='text-xl sm:text-2xl text-[#a37b5b] pb-6 sm:pb-6'>
                            ...
                            <h3 className='text-base sm:text-xl text-[#333] pb-10'>
                    ...
                    <div>
                        <h4 className='text-[#005b94] text-xl sm:text-2xl font-bold mt-20 pl-2'>
