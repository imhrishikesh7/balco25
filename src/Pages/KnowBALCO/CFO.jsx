                    ...
                    {[
                        {
                            ...
                            text: [
                                `I am pleased to share that financial year 2024–25 was a strong one for BALCO, both operationally and financially. We exceeded our performance targets and laid a solid foundation for future growth. Our focus remained on creating longterm value for all stakeholders.`,
                                `This year, we followed a disciplined approach to capital allocation, made strategic investments, and worked on improving operational efficiency. These efforts have strengthened our financial position and prepared us for sustainable growth.`
                            ]
                        },
                        {
                            ...
                            "We also achieved a significant milestone with a 20% revenue growth, reaching H 15,808 crore. The company's operational profitability was strong, with EBITDA reaching ₹ 4,534 crore, delivering an EBITDA margin of 29%. Ultimately, BALCO's PAT for FY25 stood at ₹ 2,969 crore, reflecting a solid year of financial performance.",
                            "Our emphasis on financial discipline has laid the groundwork for an enhanced credit rating to CRISIL AA (Stable), and increasing business valuation. These efforts represent our commitment to delivering long-term value to our stakeholders."]
                        },
                        {
                            heading: 'Growth is in the Numbers',
                            text: ["As India's leading aluminium producer, we're focused on building our strengths to support the country's growth. We've invested heavily in expanding capacity and driving innovation. A key example is the BALCO Expansion Project, which includes India's first 500+ kA potline and a fully integrated plant. With advanced automated systems for alumina and coke handling, the project boosts efficiency and modernisation.",
                            ...
                            {Array.isArray(text) ? (
                                typeof text[0] === 'string' ? (
                                    ...
                                    text.map((paragraph, idx) => (
                                        <p key={idx} className='text-base sm:text-lg text-justify mb-4'>{paragraph}</p>
                                    ))
                                ) : (
                                    // Handle array of objects with subheading and content
                                    text.map((item, idx) => (
