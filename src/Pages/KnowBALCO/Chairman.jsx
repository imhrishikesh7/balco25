        ...
        <div className='bg-[#a27b5b] flex flex-col lg:flex-row rounded-2xl overflow-hidden'>
          ...
          <div className='bg-[#e3d1c2] p-6 sm:p-8 lg:p-10 w-full lg:w-[60%] flex flex-col justify-center'>
            <p className='text-base sm:text-lg lg:text-2xl xl:text-3xl text-[#0064a8] font-bold leading-relaxed'>
              "We are committed to enhancing long- term value creation through adaption, innovation and sustainability. Our customer-centric approach, coupled with our expertise in understanding their evolving needs, enables us to maintain a competitive edge in this dynamic environment."
            </p>
        ...
        <div className='space-y-12 mt-10 text-[#1a1a1a]'>
          ...
          {[
            ...
            },
            {
              ...
              " I extend my heartfelt gratitude to my stakeholders for their unswerving support. We remain confident in our ability to capitalise on growing opportunities and create long-term value for all.",
              " Let us stride ahead with confidence, together."]
            }
          ].map(({ heading, text }, i) => (
            <div key={i}>
