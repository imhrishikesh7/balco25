    ...
    return (
        <div>
            ...
            <div className='marginal'>
                <div className='pb-20'>
                    <div>
                        <h1 className='text-4xl sm:text-5xl lg:text-6xl pb-6 sm:pb-10'>
                    ...
                    <div className='flex flex-col lg:flex-row'>
                        <div className='border-b lg:border-b-0 lg:border-r border-black-500 pb-6 lg:pb-0 pr-0 lg:pr-16'>
                            <p>
            ...
            <div className='marginal'>
                <div>
                    <h1 className='font-extrabold text-xl sm:text-2xl pl-5 text-[#005b94] mb-4'>Our Triumphs</h1>
                </div>

                <div className="text-container w-full flex flex-col justify-end items-start hero-section-digital mb-6">
